...
export default function Navbar() {
    ...
    return (
        ...
        id="navbar">
            <section>
                <svg onClick={() => dispatch(setNavbarState(!navbarState))} width="2.5rem" height="2.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Menu / Menu_Alt_05"> <path id="Vector" d="M5 17H13M5 12H19M11 7H19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>
                <h1 onClick={() => navigate("/")}>Synergy</h1>
                <ul className={navbarState && "active"}>
                    <li onClick={() => route("/") }>Home</li>
                    <li onClick={() => route("/events") }>Events</li>
                    <li onClick={() => route("/jobs") }>Job Board</li>
                    <li onClick={() => route("/community") }>Community</li>
                    <li onClick={() => route("/about") }>About Us</li>

                    <svg onClick={() => dispatch(setNavbarState(false))} className="closeBtn" width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Menu / Close_MD"> <path id="Vector" d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>                </ul>
            </section>
