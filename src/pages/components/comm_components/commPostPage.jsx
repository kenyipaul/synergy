...
function CommentSection() {
    ...
    useEffect(() => {
        ...
        postData.post_comments && setComments(postData.post_comments.reverse());
...
function Comment(props) {
    ...
    useEffect(() => {
        postData && setReplies(postData.post_replies)
    ...
    const postReply = () => {
        ...
        Axios({
            ...
            data: { postId, userId, reply, commId }
        }).then((response) => {
